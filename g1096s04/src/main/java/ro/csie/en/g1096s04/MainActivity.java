...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void viewChart(View view) {
        //pentru a vedea chart-ul, trebuie sa cream o instanta a bazei de date
        DatabaseManager db = DatabaseManager.getInstance(this);
        //si o instanta a interfetei Dao
        MovieDao movieDao = db.getMovieDao();

        //avem nevoie sa luam toate obiectele si sa le stocam intr-o lista
        List<Movie> allMovies = movieDao.getAllMovies();
        //iar dupa aceea putem crea chart-ul propriu zis, creat din instantele Movie urilor
